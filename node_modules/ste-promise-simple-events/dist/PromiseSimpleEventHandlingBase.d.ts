 ...
 */
export declare abstract class PromiseSimpleEventHandlingBase<TArgs> extends HandlingBase<IPromiseSimpleEventHandler<TArgs>, PromiseSimpleEventDispatcher<TArgs>, PromiseSimpleEventList<TArgs>> implements IPromiseSimpleEventHandling<TArgs> {
    constructor();
}
