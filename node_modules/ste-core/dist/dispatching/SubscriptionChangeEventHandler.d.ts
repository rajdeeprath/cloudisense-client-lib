 ...
 */
export declare type SubscriptionChangeEventHandler = (count: number) => void;
/**
 ...
 */
export declare class SubscriptionChangeEventDispatcher extends DispatcherBase<SubscriptionChangeEventHandler> {
    /**
